...
<main class="mx-auto max-w-3xl px-6 py-16">
    <header class="mb-10">
        <div class="font-mono text-xs uppercase tracking-[0.2em] text-day-muted">Archive</div>
        <h1 class="mt-2 text-4xl font-bold tracking-tight"><?php the_archive_title(); ?></h1>
        <?php the_archive_description('<div class="mt-3 text-day-muted">', '</div>'); ?>
    </header>
    ...
    <?php else: ?>
        <p class="text-day-muted"><?php esc_html_e('Nothing here.', 'funnie'); ?></p>
    <?php endif; ?>
</main>
<?php get_footer(); ?>
